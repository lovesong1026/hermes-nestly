...
_DIRECT_SURFACE_TOOLSETS = frozenset({
    "desktop_ui", "project",
    # The web-chat sandbox tools are deliberately selected only by the
    # web_chat platform.  Once selected, keep their schemas direct: the
    # model must be able to read an uploaded file or manage its private
    # skill without a tool-search round trip.
    "web_file", "web_skill", "web_memory", "web_knowledge",
})

...
TOOLSETS = {
    ...
    "hermes-web-chat": _ts(
        "Multi-user web chat with a conservative shared-process tool whitelist",
        ["web_search", "web_extract", "vision_analyze", "image_generate", "skills_list", "skill_view", "skill_manage", "todo", "session_search",
         # Registered only when the web adapter starts. Listing them here makes
         # the composite's security boundary explicit and lets the platform
         # resolver retain their dynamic registry toolsets.
         "web_file_read", "web_file_write", "web_file_patch", "web_file_search",
         "web_skills_list", "web_skill_view", "web_skill_install", "web_skill_delete", "web_skill_edit", "web_skill_patch",
         "web_memory", "web_knowledge_search"],
    ),
